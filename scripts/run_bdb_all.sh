...
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/CC/genData-cc.sh 100
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/CC/run-cc.sh 100
kill -s SIGINT $perfprocess
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/FFT/genData-fft.sh 100 100 0.5 
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/FFT/run-fft.sh 100 100 0.5
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/FFT/genData-fft.sh 100 100 0 
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/FFT/run-fft.sh 100 100 0
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/FFT/genData-fft.sh 100 100 1 
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/FFT/run-fft.sh 100 100 1
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/Grep/genData-grep.sh 1
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/Grep/run-grep.sh 1
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/MatrixMult/genData-matMult.sh 0.5 100 100 100
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/MatricMult/run-matMult.sh 0.5 100 100 100
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/MatrixMult/genData-matMult.sh 0 100 100 100
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/MatricMult/run-matMult.sh 0 100 100 100
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/MatrixMult/genData-matMult.sh 1 100 100 100
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/MatricMult/run-matMult.sh  100 100 100
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/MD5/genData-md5.sh 1
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/MD5/run-md5.sh 1
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/randSample/genData-randSample.sh 1
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/randSample/run-randSample.sh 1
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/Sort/genData-sort.sh 1
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/Sort/run-sort.sh 1
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/wordcount/genData-wc.sh 1
kill -s SIGINT $perfprocess
echo "Starting sleep after prep"
sleep 10
...
perfprocess=$!
echo "Perf process: $perfprocess"
ssh user@192.168.122.39 -i ~/id_rsa -C /home/user/bdb/BigDataBench_V5.0_BigData_MicroBenchmark/Hadoop/wordcount/run-wc.sh 1
kill -s SIGINT $perfprocess
echo "Starting sleep after run"
sleep 10
