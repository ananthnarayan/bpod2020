...
eventNames=("Timestamp","CPUs","Area","Value","Unit","Description",'Sample',"Stddev","Multiplex",'Bottleneck')
#Turns out we didn't use this string at all. :) 
eventNamesString='Timestamp,CPUs,Area,Value,Unit,Description,Sample,Stddev,Multiplex,Bottleneck'
