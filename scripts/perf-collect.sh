...
perf stat -d -d -d ./genData-randSample.sh 1000 -x '\n' -o ../../../Results/hadoop-randSample-gen.data

perf stat -d -d -d ./run-randSample.sh 1000 0.1 -x '\n' -o ../../../Results/hadoop-randSample.data

# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 

cd ../../Spark/RandSample

perf stat -d -d -d ./genData-randSample.sh 10000 -x '\n' -o ../../../Results/spark-randSample-gen.data

perf stat -d -d -d ./runSpark-randSample.sh 10000 -x '\n' -o ../../../Results/spark-randSample.data

# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 

cd ../../MPI/mpiRandSample

perf stat -d -d -d sh genData_randsample.sh -x '\n' -o ../../../Results/mpich-randSample-gen.data

make

perf stat -d -d -d mpirun -n 10 ./mpi-randsample data-randsample/lda_wiki1w_1 out 0.5 -x '\n' -o ../../../Results/mpi-randSample.data

# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 

cd ../../Hadoop/FFT

perf stat -d -d -d ./genData-fft.sh 100 100 0.5 -x '\n' -o ../../../Results/hadoop-fft-gen.data

perf stat -d -d -d ./run-fft.sh 100 100 0.5 -x '\n' -o ../../../Results/hadoop-fft.data
