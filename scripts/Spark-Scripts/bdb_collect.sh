...
vmpid=0
cleanup_bdb_cc
run_remote_workload_bdb $vmpid "bayes" "prep" "Bayes/genData-bayes.sh $bayes" $time_log $set
run_remote_workload_bdb $vmpid "bayes" "run" "Bayes/runSpark-bayes.sh $bayes" $time_log $set
cleanup_bdb "bayes"
